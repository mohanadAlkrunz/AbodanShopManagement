 ...
 * @author DELL
 */
public class EditCustomerActivity extends javax.swing.JFrame {
    ...
    /**
     * Creates new form EditCustomerActivity
     */
    public EditCustomerActivity(int customerID) {
        initComponents();
...
UIManager.put("OptionPane.messageFont", new FontUIResource(new Font(
    ...
    //  now we can get the connection from the DriverManager
       ...
       s.execute("select ID,CUSTOMER_NAME,CUSTOMER_PHONE,CUSTOMER_ADDRESS from Customers");
    ...
    private void initComponents() {
        ...
        customerAddress.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        customerAddress.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jPanel1.add(customerAddress);
        customerAddress.setBounds(470, 390, 150, 40);
        ...
        deleteProduct.setText("حذف الزبون");
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        if(customerName.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "اسم الزبون مطلوب");
            return;
        }
        ...
        if(customerAddress.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "العنوان مطلوبة");
            return;
        }
         ...
         if (rs != null){ // if rs == null, then there is no ResultSet to view
            ...
            while ( rs.next())// this will step through our data row-by-row
            {
                if(customerID==rs.getInt("ID")){
                         ...
                         rs.updateString("CUSTOMER_NAME", customerName.getText());
                         rs.updateString("CUSTOMER_PHONE", customerPhone.getText());
                         rs.updateString("CUSTOMER_ADDRESS", customerAddress.getText());
                     rs.updateRow();
    ...
    private void backMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backMouseClicked
        // TODO add your handling code here:
        new ViewCustomersActivity().setVisible(true);
        setVisible(false);
